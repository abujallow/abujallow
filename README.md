...
- AI Agent Systems & Safety Design
- Market Data Analysis  
- Monitoring & Alert Systems  
- Backend Systems & Logging  
  
## Skills
**Languages & Tools:** Python, Java, SQL, JavaScript, Git, Excel  
**Libraries & Frameworks:** pandas, scikit-learn, Flask, FastAPI, Next.js, ReportLab  
**AI & Data Infrastructure:** LLM agent design (OpenRouter), multi-source data validation, REST APIs, Vercel/Render deployment
## Contact
